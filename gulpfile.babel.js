...
const config = {
   ...
   veeva: {
      ...
      key_messages: {
         '1_rheum_hcp_iva_U3': {
            description: 'Mallinckrodt Commitment',
            title: 'Mallinckrodt Commitment'
         },
         '2_rheum_hcp_iva_U3': {
            description: 'Rheumatology Home',
            title: 'Rheumatology Home'
         },
         '3_rheum_hcp_iva_U3': {
            description: 'Potential MOA',
            title: 'Potential MOA'
         },
         '4_rheum_hcp_iva_U3': {
            description: 'Potential MOA',
         ...
         '8_rheum_hcp_iva_U3': {
            description: 'DM-PM: Study Design',
            title: 'DM-PM: Study Design'
         },
         '9_rheum_hcp_iva_U3': {
            description: 'DM-PM: Study Assessments',
            title: 'DM-PM: Study Assessments'
         },
         '10_rheum_hcp_iva_U3': {
            description: 'DM-PM: Patient Characteristics',
            title: 'DM-PM: Patient Characteristics'
         },
         '11_rheum_hcp_iva_U3': {
            description: 'DM-PM: Study Results/Safety',
            title: 'DM-PM: Study Results/Safety'
         },
         '12_rheum_hcp_iva_U3': {
            description: 'DM-PM: Case Study 1',
            title: 'DM-PM: Case Study 1'
         },
         '13_rheum_hcp_iva_U3': {
            description: 'DM-PM: Case Study 2',
            title: 'DM-PM: Case Study 2'
         },
         '14_rheum_hcp_iva_U3': {
            description: 'SLE: Study Design',
            title: 'SLE: Study Design'
         },
         '15_rheum_hcp_iva_U3': {
            description: 'SLE: Study Assessments',
            title: 'SLE: Study Assessments'
         },
         '16_rheum_hcp_iva_U3': {
            description: 'SLE: Patient Characteristics',
            title: 'SLE: Patient Characteristics'
         },
         '17_rheum_hcp_iva_U3': {
            description: 'SLE: Study Results/Safety',
            title: 'SLE: Study Results/Safety'
         },
         '18_rheum_hcp_iva_U3': {
            description: 'SLE: Case Study 1 - Patient Characteristics',
            title: 'SLE: Case Study 1 - Patient Characteristics'
         },
         '19_rheum_hcp_iva_U3': {
            description: 'SLE: Case Study 1 - Acthar Treatment',
            title: 'SLE: Case Study 1 - Acthar Treatment'
         },
         '20_rheum_hcp_iva_U3': {
            description: 'SLE: Case Study 2 - Patient Characteristics',
            title: 'SLE: Case Study 2 - Patient Characteristics'
         },
         '21_rheum_hcp_iva_U3': {
            description: 'SLE: Case Study 2 - Acthar Treatment',
            title: 'SLE: Case Study 2 - Acthar Treatment'
         },
         '22_rheum_hcp_iva_U3': {
            description: 'Sarcoidosis: Study Design',
            title: 'Sarcoidosis: Study Design'
         },
         '23_rheum_hcp_iva_U3': {
            description: 'Sarcoidosis: Study Assessments',
            title: 'Sarcoidosis: Study Assessments'
         },
         '24_rheum_hcp_iva_U3': {
            description: 'Sarcoidosis: Patient Characteristics',
            title: 'Sarcoidosis: Patient Characteristics'
         },
         '25_rheum_hcp_iva_U3': {
            description: 'Sarcoidosis: Study Results',
            title: 'Sarcoidosis: Study Results'
         },
         '26_rheum_hcp_iva_U3': {
            description: 'Sarcoidosis: Safety Findings',
            title: 'Sarcoidosis: Safety Findings'
         },
         '27_rheum_hcp_iva_U3': {
            description: 'RA: Study Design',
            title: 'RA: Study Design'
         },
         '28_rheum_hcp_iva_U3': {
            description: 'RA: Interim Study Assessments',
            title: 'RA: Interim Study Assessments'
         },
         '29_rheum_hcp_iva_U3': {
            description: 'RA: Interim pt_disposition',
            title: 'RA: Interim pt_disposition'
         },
         '30_rheum_hcp_iva_U3': {
            description: 'RA: Patient Characteristics',
            title: 'RA: Patient Characteristics'
         },
         '31_rheum_hcp_iva_U3': {
            description: 'RA: Patient Demographics',
            title: 'RA: Patient Demographics'
         },
         '32_rheum_hcp_iva_U3': {
            description: 'RA: Study Results',
            title: 'RA: Study Results'
         },
         '33_rheum_hcp_iva_U3': {
            description: 'RA: open_label_treatment_period',
            title: 'RA: open_label_treatment_period'
         },
         '34_rheum_hcp_iva_U3': {
            description: 'RA: double_blind_withdrawal_period_1',
            title: 'RA: double_blind_withdrawal_period_1'
         },
         '35_rheum_hcp_iva_U3': {
            description: 'RA: double_blind_withdrawal_period_2',
            title: 'RA: double_blind_withdrawal_period_2'
         },
         '36_rheum_hcp_iva_U3': {
            description: 'RA: Safety Limitations ',
            title: 'RA: Safety Limitations '
         },
         '37_rheum_hcp_iva_U3': {
            description: 'Rheumatology Dosing',
            title: 'Rheumatology Dosing'
         },
         '38_rheum_hcp_iva_U3': {
            description: 'Acthar Support Services',
            title: 'Acthar Support Services'
         },
         '39_rheum_hcp_iva_U3': {
            description: 'Mallinckrodt Commitment',
            title: 'Mallinckrodt Commitment'
         ...
         '73_rheum_hcp_iva_U3_PI': {
            description: 'Acthar PI',
            title: 'Acthar PI'
         },
